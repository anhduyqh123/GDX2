...
public class IJson {
    ...
    protected boolean ignoreDeprecated;
    protected boolean readDeprecated;
    ...
    public IJson (OutputType outputType) {
    ...
    static public interface Serializer<T> {
        public void write (IJson json, T object, Class knownType);

        public T read (IJson json, JsonValue jsonData, Class type);
    }
    ...
    static abstract public class ReadOnlySerializer<T> implements Serializer<T> {
        ...
        abstract public T read (IJson json, JsonValue jsonData, Class type);
    }

    static public interface Serializable {
        public void write (IJson json);

        public void read (IJson json, JsonValue jsonData);
    }
}
